...
load("integrationservices/applications/nagios/configuration_host.js");
...
function apia_callback(msg)
{
  ...
  if( msg.xmatters_callback_type == 'response' ) {
    ...
    if ( msg.response == "Acknowledge" ) {
      ...
      nagiosCmdStr = "[" + timestamp + "] ADD_HOST_COMMENT;" + msg.additionalTokens.host + ";1;" + msg.recipient + ";" + comment + " \\n";
      ...
      var comment = "Acknowledgement and sched downtime from xMatters by " + msg.recipient + " - " + msg.device;
      if (msg.annotation != "null") {
       	comment += " - " + msg.annotation
      }
	  ...
	  nagiosCmdStrSHD = "[" + timestamp + "] SCHEDULE_HOST_DOWNTIME;" + msg.additionalTokens.host + ";" + timestamp + ";" + timestamp_end + ";1;0;3600;" + msg.recipient + ";" + comment + " \\n";

	  var output = execute(nagiosCmdStrSHD);
	  }
    else {
